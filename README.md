...
| [Python for Data Analysis](https://wesmckinney.com/book/) | Wes McKinney | 🟢 | XXXX | 2023 | [📖](https://wesmckinney.com/book/)  [📙](https://github.com/wesm/pydata-book) | 
**COURSES**
...
| --- | --- | --- | --- | --- | --- |
**BOOKS** | | | | | 
[Mathematics for Machine Learning](https://mml-book.github.io/book/mml-book.pdf) | M. Deisenroth, A. Faisal and C. Ong | 🟡 | Very good guidebook covering the mathematical foundations of modern ML. Chapter 5 covers vector calculus. | 2020 | [📖](https://mml-book.github.io/) |
...
| --- | --- | --- | --- | --- | --- |
**BOOKS** | | | | | 
| [Introduction to Probability for Data Science](https://probability4datascience.com/index.html) | Stanley Chan | 🟢 | XXXX | 2021 | [📖](https://probability4datascience.com/index.html) [🎥](https://www.youtube.com/playlist?list=PL4FSfq6xtSvxD8JXYWuljrPE42yQObZXc) 
| [Think Stats: Probability and statistics for programmers](https://allendowney.github.io/ThinkStats2/) | Allen Downey | 🟢 | Use Python skills to learn probability and statistics concepts. |  | [📖](https://greenteapress.com/thinkstats2/thinkstats2.pdf) [📙](https://github.com/AllenDowney/ThinkStats2/notebooks) [🌐](https://www.allendowney.com/blog/)|
|[Think Bayes: Bayesian statistics made simple](http://allendowney.github.io/ThinkBayes2/) | Allen Downey | 🟢 | Introduction to Bayesian statistics using computational methods in Python. |  | [📖](http://allendowney.github.io/ThinkBayes2/) [📙](https://github.com/AllenDowney/ThinkBayes2/notebooks) [🌐](https://www.allendowney.com/blog/)|
...
| [Computer Age Statistical Inference](https://hastie.su.domains/CASI_files/PDF/casi.pdf) | B. Efron and T. Hastie | 🟡 | XXXX | 2021 | [📖](https://hastie.su.domains/CASI_files/PDF/casi.pdf) | 
...
| [Introduction to ML for Coders](https://www.fast.ai/posts/2018-09-26-ml-launch.html) | fast.ai | 🟢 | Practical introduction to ML from Jeremy Howard. | 2018 | [🎥](https://www.youtube.com/watch?v=CzdWqFTmn0Y&list=PLfYUBJiXbdtSyktd8A_x0JNd6lxDcZE96) [📖](https://mlbook.explained.ai/) |
...
| [Dive into Deep Learning](https://d2l.ai/index.html) | A. Zhang, Z. Lipton, M. Li and A. Smola | 🟡 | Interactive deep learning book with code, math and discussions. Each section can be run as Jupyter Notebook. | 2022 | [📖](https://d2l.ai/index.html) [📙](https://d2l.ai/index.html) |
| [Understanding Deep Learning](https://udlbook.github.io/udlbook/) | Simon Prince | 🟡 | Book covering the ideas that underlie deep learning and many different architectures. | 2023 | [📖](https://udlbook.github.io/udlbook/) [📊](https://udlbook.github.io/udlbook/) [📙](https://github.com/udlbook/udlbook/tree/main/Notebooks) |
...
| [Practical Deep Learning for Coders 2022: Part 1](https://course.fast.ai/) | Fast.ai | 🟢 | A free course designed for people with some coding experience, who want to learn how to apply deep learning and machine learning to practical problems. | 2022 | [📖](https://course.fast.ai/Resources/book.html) [🎥](https://www.youtube.com/watch?v=8SF_h3xF3cE&list=PLfYUBJiXbdtSvpQjSnJJ_PmDQB_VyT5iU&pp=iAQB) [📙](https://github.com/fastai/course22)|
...
| [NYU Deep Learning](https://cds.nyu.edu/deep-learning/) | NYU | 🟡 | Covers techniques in deep learning with applications to computer vision, NLP, and speech recognition. | 2021 | [🎥](https://www.youtube.com/playlist?list=PLLHTzKZzVU9e6xUfG10TkTWApKSZCzuBI) [📙](https://github.com/Atcold/NYU-DLSP20/tree/master) | 
| [Deep Learning Course](https://fleuret.org/dlc/) | University of Geneva | 🟡 | Introduction to deep learning by Francois Fleuret with examples in PyTorch. | 2021 | [🎥](https://mediaserver.unige.ch/play/144022) [📊](https://fleuret.org/dlc/#lectures) |
...
| [Deep Learning I](http://uvadlc.github.io/#lecture) | University of Amsterdam | 🟡  | XXXX | 2023 | [🎥](https://www.youtube.com/@uvadeeplearningcourse5754) [📙](https://uvadlc-notebooks.readthedocs.io/en/latest/index.html) | 
| [Deep Learning II](https://uvadl2c.github.io/) | University of Amsterdam | 🔴 | XXXX | 2023 | [🎥](https://www.youtube.com/@deeplearningii8059/featured) [📊](https://uvadl2c.github.io/#:~:text=%2C%20Riccardo%20Valperga-,Modules,-Module%201%3A%20Group) [📙](https://uvadlc-notebooks.readthedocs.io/en/latest/index.html#:~:text=Learning%20with%20SimCLR-,DEEP%20LEARNING%202,-GDL%20%2D%20Regular%20Group) |
| [Deep Learning Systems](https://dlsyscourse.org/lectures/) | CMU | 🔴 | Design and build from scratch a complete deep learning library, capable of efficient GPU-based operations, automatic differentiation of all implemented functions, and the necessary modules to support parameterized layers, loss functions, data loaders, and optimizers. | 2022 | [🌐](https://dlsyscourse.org/lectures/) [🎥](https://dlsyscourse.org/lectures/) [📊](https://dlsyscourse.org/lectures/) [💻](https://github.com/dlsyscourse) |
**YOUTUBE PLAYLISTS**
...
| [Deep Learning for Computer Vision: Fundamentals and Applications](https://dl4cv.github.io/DL4CV_Winter23/index.html) | Weizmann Institute of Science | 🟡 | Course by Justin Johnson that provides hands-on experience with deep learning for computer vision: implementing deep neural networks and their components from scratch, tackling real world tasks in computer vision using PyTorch. Videos from 2021 version of course. | 2023 | [🎥](https://www.youtube.com/playlist?list=PL_Z2_U9MIJdNgFM7-f2fZ9ZxjVRP_jhJv) [📊](https://dl4cv.github.io/DL4CV_Winter23/schedule.html) |
...
**YOUTUBE PLAYLIST**
| [Reinforcement Learning](https://www.youtube.com/playlist?list=PLMrJAkhIeNNQe1JXNvaFvURxGY4gE9k74) | University of Washington | 🟢 |  This playlist by Steve Bunton gives a high-level overview to many of the most relevant topics in this field. | 2023 | [🎥](https://www.youtube.com/playlist?list=PLMrJAkhIeNNQe1JXNvaFvURxGY4gE9k74) |
...
| [Effective MLOps: Model Development](https://www.wandb.courses/courses/effective-mlops-model-development) | Weights & Biases | 🟢 | XXXX | | [🌐](https://www.wandb.courses/courses/effective-mlops-model-development) |
| [Iterative Tools for Data Scientists & Analysts](https://learn.iterative.ai/) | Iterative | 🟢 | You will learn to apply the best practices from software development to machine learning projects. Iterative tools enable  version control of data, models and experiments as well as CI/CD for machine learning projects. | | [🌐](https://learn.iterative.ai/) |
...
| [Serverless Machine Learning & Principles of MLOps](https://www.serverless-ml.org/sml-course) | serverless-ml.org | 🟡 | In this course, you will build a prediction service, not just train a model. This will take you to the next step in Machine Learning (ML). | | [🌐](https://www.serverless-ml.org/sml-course) [🎥](https://www.youtube.com/playlist?list=PLMeDf8qRRqgU_-erq30v-k8_it4pOqhoQ) [📊](https://github.com/featurestoreorg/serverless-ml-course#modules) [💻](https://github.com/featurestoreorg/serverless-ml-course) |


## Specailization: Applied ML/DL

| Title | Provider | Level |Description | Latest release | Resources |
| --- | --- | --- | --- | --- | --- |
**COURSES**
| [Machine Learning for Healthcare](https://ocw.mit.edu/courses/6-s897-machine-learning-for-healthcare-spring-2019/) | MIT | 🟡 | Introduces students to machine learning in healthcare, including the nature of clinical data and the use of machine learning for risk stratification, disease progression modeling, and precision medicine. | 2019 | [🌐](https://mlhcmit.github.io/) [🎥](https://www.youtube.com/playlist?list=PLUl4u3cNGP60B0PQXVQyGNdCyCTDU1Q5j) [📊](https://mlhcmit.github.io/#:~:text=into%20clinical%20practice.-,Schedule,-The%20schedule%20is) [📝](https://ocw.mit.edu/courses/6-s897-machine-learning-for-healthcare-spring-2019/pages/lecture-notes/)|
| [Self-driving Cars](https://uni-tuebingen.de/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/informatik/lehrstuehle/autonomous-vision/lectures/self-driving-cars/) | University of Tübingen | 🟡 | This course covers the most dominant paradigms of self-driving cars: modular pipeline-based approaches as well as deep-learning based end-to-end driving techniques. | 2021 | [🎥](https://www.youtube.com/playlist?list=PL05umP7R6ij321zzKXK6XCQXAaaYjQbzr) [📊](https://uni-tuebingen.de/fakultaeten/mathematisch-naturwissenschaftliche-fakultaet/fachbereiche/informatik/lehrstuehle/autonomous-vision/lectures/self-driving-cars/#:~:text=the%20lecture%20slides-,Schedule,-Date)|
...
| [Advanced Robotics](https://people.eecs.berkeley.edu/~pabbeel/cs287-fa19/) | UC Berkeley | 🟡 | Course by Peter Abbeel reviewing reinforcement learning and applications in robotics. | 2019 | [🎥](https://www.youtube.com/playlist?list=PLwRJQ4m4UJjNBPJdt8WamRAt4XKc639wF) |
| [Deep Learning in Fluid Mechanics](http://databookuw.com/page-5/page-24/) | University of Washington | 🟡 | XXXX | 20XX | [🎥](https://www.youtube.com/watch?v=8e3OT2K99Kw&list=PLMrJAkhIeNNQWO3ESiccZmPssvUDFHL4M) [🌐](http://databookuw.com/page-5/page-24/) |
...
| [Parallel Computing and Scientific Machine Learning (SciML): Methods and Applications](https://www.youtube.com/watch?v=3IoqyXmAAkU&list=PLCAl7tjCwWyGjdzOOnlbGnVNZk0kB8VSa&index=1&t=1849s) | MIT | 🟡 | Covers scientific machine learning, including how partial differential equation simulations can be accelerated with neural networks. | | [🎥](https://www.youtube.com/watch?v=3IoqyXmAAkU&list=PLCAl7tjCwWyGjdzOOnlbGnVNZk0kB8VSa&index=1&t=1849s) [📖](https://book.sciml.ai/) |
