...
| [Deep Reinforcement Learning]() | AI Summer | 🟢 |  Provides an intuitive explanation of the ideas behind all the algorithms that 
revolutionalize Artificial Intelligence over the past years, without getting into much math. | | [🌐](https://theaisummer.com/deep_reinforcement_learning_course/) |
...
| --- | --- | --- | --- | --- | --- |
**COURSES**
| [Machine Learning for Healthcare](https://ocw.mit.edu/courses/6-s897-machine-learning-for-healthcare-spring-2019/) | MIT | 🟡 | Introduces students to machine learning in healthcare, including the nature of clinical data and the use of machine learning for risk stratification, disease progression modeling, and precision medicine. | 2019 | [🎥](https://www.youtube.com/playlist?list=PLUl4u3cNGP60B0PQXVQyGNdCyCTDU1Q5j) [📊](https://ocw.mit.edu/courses/6-s897-machine-learning-for-healthcare-spring-2019/pages/lecture-notes/) [📝](https://ocw.mit.edu/courses/6-s897-machine-learning-for-healthcare-spring-2019/pages/lecture-notes/)|
